...
<div class="container">
  ...
  <div class="card mb-4" @if($isDocs) style="display:none" @endif>
    <div class="card-header"><h3>{{ __('Vendor Details') }}</h3></div>
    <div class="card-body">
      <form method="POST" action="{{ route('panel.vendor.store') }}" enctype="multipart/form-data">
        @csrf
