...
class OrderController extends Controller
{
    ...
    public function orders() {
        ...
        if (auth()->user()->user_type == 'vendor') { // If the authenticated/logged-in user is 'vendor', we show ONLY the orders of the products added by that specific 'vendor' ONLY
            ...
            // dd($orders);
         return view('pages.panel.check_orders')->with(compact('orders'));
    ...
    public function orderDetails($id) {
        ...
        if (auth()->user()->user_type == 'vendor') { // If the authenticated/logged-in user is 'vendor', we show ONLY the details of the orders of the products added by that specific 'vendor' ONLY (from `orders_products` table) in admin/orders/order_details.blade.php page
       ...
       //  dd($orderDetails);
        ...
        return view('pages.panel.order_details')->with(compact('orderDetails', 'userDetails', 'orderStatuses', 'orderItemStatuses', 'orderLog', 'item_discount'));
    }
